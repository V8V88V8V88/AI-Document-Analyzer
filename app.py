...
def main():
    ...
    # Modern CSS with professional styling and animations
    st.markdown("""
    <style>
    ...
    :root {
        ...
        --sidebar-bg-color: #1C1C1E;     /* Sidebar & chat input */
        --text-color: #E5E5E7;           /* Primary text */
        --subtle-text-color: #9C9C9F;    /* Secondary text */
        --card-bg-color: #2C2C2E;        /* Cards / chat bubbles */
        --hover-bg-color: #3A3A3C;       /* Hover state */
        --border-color: #3A3A3C;         /* Hairline borders */
        --accent-color: #FFD56B;         /* Soft golden accent */
        --shadow-color: rgba(0,0,0,0.25); /* Shadows */
    }
    ...
    * {
    ...
    /* Style for the selected radio button's wrapper div */
    ...
    /* Override Streamlit alert/info backgrounds */
    .stAlert {
    ...
    /* Remove blue accents from file uploader */
    ...
    .stFileUploader svg path {
        fill: var(--subtle-text-color) !important;
    }
